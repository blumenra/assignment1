...
// 	Card* figureCardT = new FigureCard(shape, figure);
// 	Card* numericCardT = new NumericCard(shape, 1234);


// 	// isFigure
// 	cout << "isFigure? (figure): " << figureCardT->isFigure() << endl;
// 	cout << "isFigure? (numeric): " << numericCardT->isFigure() << endl;
// 	cout << "isFigure? (figure): " << figureCardT->isNumeric() << endl;
// 	cout << "isFigure? (numeric): " << numericCardT->isNumeric() << endl;
...
// 	// // copy constructor
// 	// cout << "Deck: " << deck.toString() << endl;
// 	// Deck copiedDeck(deck);
// 	// cout << "copiedDeck: " << copiedDeck.toString() << endl;
// 	// cout << endl;


// 	//operator=
// 	Deck deckA = Deck(cards2);
// 	cout << "after A" << endl;
// 	Deck deckB;
// 	deckB = deckA;

// 	cout << "Deck: " << deckA.toString() << endl;
// 	cout << "operator=: " << deckB.toString() << endl;
// 	cout << "Deck: " << deckA.toString() << endl;
